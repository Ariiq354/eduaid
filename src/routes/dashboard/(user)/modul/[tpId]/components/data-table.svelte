<script lang="ts">
  ...
  import type { selectmodul } from '$lib/server/schema';
  ...
  export let data: selectmodul[];
  export let tpId: string;
  ...
  const columns = table.createColumns([
    ...
    table.column({
      ...
      header: 'Menu',
      cell: ({ value }) => {
        return createRender(DataTableActions, { id: value, tpId: tpId });
      },
      plugins: {
        sort: {
          disable: true
